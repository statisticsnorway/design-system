...
const overviewText = `
Rad- og kolonneoverskrifter er viktige. En celle fungerer som overskrift hvis den beskriver innholdet i cellene under eller ved siden av. Tall bør høyrejusteres for enklere sammenligning.
`;
