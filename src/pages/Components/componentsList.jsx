...
const componentsList = [
	...
	{
		component: CheckboxInfo,
		label: 'Checkbox',
		path: '/checkbox',
		icon: checkboxIcon,
	},
	{
		component: DividerInfo,
		label: 'Divider',
		path: '/divider',
		icon: dividersIcon,
	},
	{
		component: DropdownInfo,
		label: 'Dropdown',
		path: '/dropdown',
		icon: dropdownIcon,
	},
	{
		component: FactBoxInfo,
		label: 'Fact Box',
		path: '/fact-box',
		icon: factboxIcon,
	},
	...
	{
		component: GlossaryInfo,
		label: 'Glossary',
		path: '/glossary',
		icon: wordExplanationIcon,
	},
	{
		component: '',
		label: 'Graphs',
	...
	{
		component: QuotesInfo,
		label: 'Quote and Highlighting	',
		path: '/quotes',
		icon: quoteIcon,
	},
	{
		component: RadioButtonInfo,
		label: 'Radio Buttons',
		path: '/radiobutton',
